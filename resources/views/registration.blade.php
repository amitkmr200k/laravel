...
<div class="form well">
    ...
    <div class="row">
        ...
        <div class="col-sm-4"><b>Confirm Password </b><br/>
            ...
            value="" name="password_confirmation" placeholder="password">
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4"><b>Employer</b> <br/>
            ...
            value="{{ old('employer') }}" name="employer">
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4"><b>City</b> <br/>
            ...
            value="{{ old('residence_city') }}" name="residence_city">
        </div>
        <div class="col-sm-4"><b>State</b> <br/>
            <input class="form-control" id="residence_state" type="text"
            value="{{ old('residence_state') }}" name="residence_state">
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4"><b>Contact No.</b> <br/>
            <input class="form-control" id="residence_contact_no" type="text"
            value="{{ old('residence_contact_no') }}" name="residence_contact_no"
            maxlength=10>
        </div>
        <div class="col-sm-4"><b>Fax</b> <br/>
            <input class="form-control" id="residence_fax_no" type="text"
            value="{{ old('residence_fax_no') }}" name="residence_fax_no"
            maxlength=10>
        </div>
    ...
    <div class="row">
        ...
        <br/><br/><br/>
        <div class="col-sm-4"><b>Street</b><br/>
            <input class="form-control" id="permanent_street" type="text"
            value="{{ old('permanent_street') }}" name="permanent_street">
        </div>
        <div class="col-sm-4"><b>City</b><br/>
            <input class="form-control" id="permanent_city" type="text"
            value="{{ old('permanent_city') }}" name="permanent_city">
        </div>
        <div class="col-sm-4"><b>State</b><br/>
            <input class="form-control" id="permanent_state" type="text"
            value="{{ old('permanent_state') }}" name="permanent_state">
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4"><b>Contact No.</b> <br/>
            <input class="form-control" id="permanent_contact_no" type="text"
            value="{{ old('permanent_contact_no') }}" name="permanent_contact_no"
            maxlength=10>
        </div>
        <div class="col-sm-4"><b>Fax</b> <br/>
            <input class="form-control" id="permanent_fax_no" type="text"
            value="{{ old('permanent_fax_no') }}" name="permanent_fax_no"
            maxlength=10>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            accept="image/x-png, image/gif, image/jpeg">{{ old('image') }}
            <img id="image" src="img/dp.png" alt="image preview here"
...
@section('script')
<script type="text/javascript" src="js/registration_validation_jquery.js">
</script>
@stop
