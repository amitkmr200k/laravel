...
<div class="well registration">
    ...
    @if (old('employment') == "yes") 
    {{--*/ $is_employed = 'selected' /*--}}
    {{--*/ $is_not_employed = '' /*--}}
    @else
    {{--*/ $is_employed = '' /*--}}
     {{--*/ $is_not_employed = 'selected' /*--}}
...
<div class="form well">
    ...
    <form id="registration_form" action="registration" enctype="multipart/form-data" method="POST" >
        <div class="row">
            ...
            <div class="col-xs-4"><p id="fname" class="error alert alert-danger glyphicon glyphicon-exclamation-sign">
        ...
        <div class="row">
            <div class="col-sm-4 "><b>Gender</b> <br/> 
                <input type="radio" name="gender" value="male"  {{ $checked_male }}> Male<br>
                <input type="radio" name="gender" value="female" {{ $checked_female }}> Female<br>
            </div>
            ...
            <div class="col-sm-4"><b>Employed</b> <br/>
                <select id ="employment" name="employment" class="btn btn-primary btn-sm">
                    <option value="yes" {{ $is_employed}}>yes</option>
                    <option value="no" {{ $is_not_employed}}>no</option>
                </select>
            </div>
