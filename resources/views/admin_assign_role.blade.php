        ...
        <div class="well admin_assign_role">
            <div class="row">
                ...
                <div class="col-sm-4 admin_assign_role_user_info">
                    ...
                    id="name_assign_role_page" disabled>
                    <br/>
                    <label>Email ID </label>
                    <input class="form-control" type="text"
                    id="email_assign_role_page" disabled>
                    <br/>
                    <label>Role </label>
                    ...
                    <br/>
                    <input class=" btn btn-primary" id="assign_role"
                    type="button" value="Assign">&nbsp;
...
<div id ="reload_hidden_user_info">
    <input type="hidden" id="hidden_user_info" value="{{$all}}">
</div>
@stop
