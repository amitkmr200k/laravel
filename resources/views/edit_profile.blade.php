...
@else
{{--*/ $gender = is_selected($gender, 'male', 'female', 'checked') /*--}}
{{--*/ $marital_status = is_selected($marital_status, 'married', 'unmarried', 'selected') /*--}}
{{--*/ $employment = is_selected($employment, 'yes', 'no', 'selected') /*--}}
...
<div class="form well">
    ...
    <form id="edit_profile_form" action="edit_profile" enctype="multipart/form-data" method="POST" >
        <div class="row">
            <div class="col-sm-4"><b>First name</b> <br/>
            <input class="form-control" id="first_name" type="text" 
            value="{{ display_value(old('first_name'), $first_name) }}" name="first_name" placeholder="First Name"> 
            </div>
            <div class="col-sm-4"><b>Middle name</b> <br/>
            <input class="form-control" id="middle_name" type="text" value="{{ display_value(old('middle_name'), $middle_name) }}" name="middle_name" placeholder="Middle Name"> 
            </div>
            <div class="col-sm-4"><b>Last name </b><br/>
            <input class="form-control" id="last_name" type="text" value="{{ display_value(old('last_name'), $last_name) }}" name="last_name" placeholder="Last Name"> 
            </div>
        ...
        <div class="row">
            ...
            <input class="form-control" id="age" type="text" value="{{ display_value(old('age'), $age) }}" name="age" placeholder="age" maxlength=3>  </div>
            <div class="col-sm-4 "><b>Date Of Birth</b> <br/>
            <input class="form-control" id="dob" type="date" value="{{ display_value(old('dob'), $dob) }}" name="dob"></div>
        ...
        <div class="row">
           ...
           <div class="col-sm-4"><b>Marital Status</b> <br/>
            ...
            <input class="form-control" id="employer" type="text" value="{{ display_value(old('employer'), $employer) }}" name="employer"></div>
        ...
        <div>
            <div class="row">
                ...
                <input class="form-control" id="residence_street" type="text" value="{{ display_value(old('residence_street'), $residence_street) }}" name="residence_street"></div>
                <div class="col-sm-4"><b>City</b> <br/>
                <input class="form-control" id="residence_city" type="text" value="{{ display_value(old('residence_city'), $residence_city) }}" name="residence_city"></div>
                <div class="col-sm-4"><b>State</b> <br/>
                <input class="form-control" id="residence_state" type="text" value="{{ display_value(old('residence_state'), $residence_state) }}" name="residence_state"></div>
            ...
            <div class="row">   
                ...
                <input class="form-control" id="residence_pincode" type="text" value="{{ display_value(old('residence_pincode'), $residence_pincode) }}" name="residence_pincode" maxlength=6></div>
                <div class="col-sm-4"><b>Contact No.</b> <br/>
                <input class="form-control" id="residence_contact_no" type="text" value="{{ display_value(old('residence_contact_no'), $residence_contact_no) }}" name="residence_contact_no" maxlength=10></div>
                <div class="col-sm-4"><b>Fax</b> <br/>
                <input class="form-control" id="residence_fax_no" type="text" value="{{ display_value(old('residence_fax_no'), $residence_fax_no) }}" name="residence_fax_no" maxlength=10></div>
        ...
        <div>               
            <div class="row">           
                ...
                <br/><br/><br/>
                <div class="col-sm-4"><b>Street</b> <br/>
                <input class="form-control" id="permanent_street" type="text" value="{{ display_value(old('permanent_street'), $permanent_street) }}" name="permanent_street"></div>
                <div class="col-sm-4"><b>City</b> <br/>
                <input class="form-control" id="permanent_city" type="text" value="{{ display_value(old('permanent_city'), $permanent_city) }}" name="permanent_city"></div>
                <div class="col-sm-4"><b>State</b> <br/>
                <input class="form-control" id="permanent_state" type="text" value="{{ display_value(old('permanent_state'), $permanent_state) }}" name="permanent_state"></div>
            ...
            <div class="row">   
                <div class="col-sm-4"><b>Pin Code</b> <br/>
                <input class="form-control" id="permanent_pincode" type="text" value="{{ display_value(old('permanent_pincode'), $permanent_pincode) }}" name="permanent_pincode"  maxlength=6></div>
                <div class="col-sm-4"><b>Contact No.</b> <br/>
                <input class="form-control" id="permanent_contact_no" type="text" value="{{ display_value(old('permanent_contact_no'), $permanent_contact_no) }}" name="permanent_contact_no" maxlength=10></div>
                <div class="col-sm-4"><b>Fax</b> <br/>
                <input class="form-control" id="permanent_fax_no" type="text" value="{{ display_value(old('permanent_fax_no'), $permanent_fax_no) }}" name="permanent_fax_no" maxlength=10></div>
        ...
        <div class="row">
            ...
            <textarea class="form-control" name="comment" placeholder="Comment here in 140 words" rows="4" cols="30">{{ display_value(old('comment'), $comment) }}</textarea></div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                ...
                <img id="image" src="img/{{ $image }}" alt="image preview here" height="150" width="150" />
