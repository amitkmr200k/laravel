...
$("#email_id").blur(function()
{
        ...
        ({
            ...
            success: function( msg ) 
            {
                if(msg.email_id=="1")
                {
                    $('#email_error').text("already exits");    
                }
                else
                {
                    $('#email_error').text("");
...
$("#user_name").blur(function()
{
        ...
        ({
            method: "POST",
            url: "check_user_name_registration",
            dataType: 'json',
            data: 
            {
                //user_name: user_name, 
...
//checking for errors
    ...
    if(flag==0)
    {
        ...
        if($('#email_error').text()!="already exits")
        {   
            $('#email_error').text(error_client[19]);
        }
